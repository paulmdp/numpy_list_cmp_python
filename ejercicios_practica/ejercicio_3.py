...
if __name__ == '__main__':
    ...
    lista_0_10 = [ n for n in range(11)]
    ...
    tabla_5 = [5*n for n in range(11)]
    print ('La tabla del 5: ', tabla_5)
    ...
    dias_mes = [random.randint(1,30) for d in range (10)]
    dias_mes.sort()
    print('Lista de diez números aleatorios de un mes: ', dias_mes)
